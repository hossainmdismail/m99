(function ($) {
    ...
    var productDetails = function () {
        ...
        $(document).on("click", ".qty-up", function (event) {
            event.preventDefault();
            var qtySpan = $(this).closest(".detail-qty").find(".qty-val");
            var inputValue = $("#inputQntValue");
            var qtyval = parseInt(qtySpan.text(), 10) + 1;
            inputValue.val(qtyval);
            qtySpan.text(qtyval);
            console.log(inputValue.val());
        });
        ...
        $(document).on("click", ".qty-down", function (event) {
            ...
            var inputValue = $("#inputQntValue");
            var qtyval = parseInt(qtySpan.text(), 10) - 1;
            qtyval = Math.max(1, qtyval); // Ensure qtyval is at least 1
            inputValue.val(qtyval);
            qtySpan.text(qtyval);
            console.log(inputValue.val());
        });
